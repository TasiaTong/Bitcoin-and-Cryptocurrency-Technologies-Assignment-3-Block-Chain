...
public class Main {
    ...
    public static void main(String[] args)
        ...
        Block genesis = new Block(null, pk_scrooge.getPublic()); // do not add other TXs
        ...
        System.out.println("Block1 Added: " + bh.processBlock(block1));
        ...
        Block block2 = new Block(block1.getHash(), pk_scrooge.getPublic());

        // new TX: scrooge pays 25 coins to scrooge

        Tx tx2 = new Tx();

        tx2.addInput(block1.getCoinbase().getHash(), 0); // 25
        ...
        System.out.println("Block2 Added: " + bh.processBlock(block2));
        /*
         * 
        ...
        System.out.println("Block3 Added: " + bh.processBlock(block3));
        ...
        System.out.println("Block4 Added: " + bh.processBlock(block4));
        ...
        tx5.addOutput(5, pk_bob.getPublic()); // <= 5
        ...
        System.out.println("Block5 Added: " + bh.processBlock(block5));
